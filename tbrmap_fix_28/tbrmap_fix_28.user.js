...
if (location.href.match(/^https:\/\/((nl|zz|en).*\.tribalwars\.(nl|net)\/(game.php|public_report).*)/)) {
    ...
    (function (f) {
        ...
        var settings = {
            ...
            config = {
                "opslaan": "https://tbrmap.twmerge.nl/opslaan.php?",
                "note": "https://tbrmap.twmerge.nl/note.php?",
                "info": "https://tbrmap.twmerge.nl/info.php?",
                "map": "https://tbrmap.twmerge.nl/map.php?",
                "version": "3.2.26",
                "farmrule": {
                    "nl5": 1200,
                    "nl10": 1800,
